...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["5596984081026@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
				...
				case 'loli':
					loli.getSFWLoli(async (err, res) => {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'eita 😏kk'})
					})
					break
				case 'nsfwloli':
					...
					loli.getNSFWLoli(async (err, res) => {
						...
						buffer = await getBuffer(res.url)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'hmm 🤠'})
					})
					break
				case 'hilih':
